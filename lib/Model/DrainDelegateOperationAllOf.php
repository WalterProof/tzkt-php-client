...
/**
 * DrainDelegateOperationAllOf Class Doc Comment
 *
 * @category Class
 * @package  Bzzhh\Tzkt
 * @author   OpenAPI Generator team
 ...
 */
class DrainDelegateOperationAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DrainDelegateOperation_allOf';
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type Type of the operation, `drain_delegate`
     *
     * @return self
     */
     ...
     * Sets delegate
     *
     * @param OneOfAlias|null $delegate Information about the drained delegate
     *
     * @return self
     */
     ...
     * Sets target
     *
     * @param OneOfAlias|null $target Information about the recipient account
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param int|null $amount Amount sent from the drained baker to the target
     *
     * @return self
     */
     ...
     * Sets fee
     *
     * @param int|null $fee Amount sent from the drained baker to the block baker
     *
     * @return self
     */
     ...
     * Sets allocation_fee
     *
     * @param int|null $allocation_fee The amount of funds burned from the drained baker for account creation (micro tez)
     *
     * @return self
     */

...
/**
 * VoterSnapshot Class Doc Comment
 *
 * @category Class
 * @package  Bzzhh\Tzkt
 * @author   OpenAPI Generator team
...
class VoterSnapshot implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VoterSnapshot';
    ...
    */
     ...
     * Sets status
     *
     * @param string|null $status Voter's status: `none` - the voter did nothing `upvoted` - the voter upvoted at least one proposal `voted_yay` - the voter voted \"yay\" `voted_nay` - the voter voted \"nay\" `voted_pass` - the voter voted \"pass\"
     *
     * @return self
     */

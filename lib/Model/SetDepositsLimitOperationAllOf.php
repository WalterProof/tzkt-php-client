<?php
/**
 * SetDepositsLimitOperationAllOf
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * SetDepositsLimitOperationAllOf Class Doc Comment
 *
 * @category Class
 * @package  Bzzhh\Tzkt
 * @author   OpenAPI Generator team
 ...
 */
class SetDepositsLimitOperationAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SetDepositsLimitOperation_allOf';
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type Type of the operation, `set_deposits_limit`
     *
     * @return self
     */
     ...
     * Sets limit
     *
     * @param string|null $limit Frozen deposits limit (mutez), or `null` if no limit.
     *
     * @return self
     */

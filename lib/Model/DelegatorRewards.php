...
class DelegatorRewards implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DelegatorRewards';
    ...
    protected static $openAPITypes = [
        ...
        'staked_balance' => 'int',
        'baker' => '\Bzzhh\Tzkt\Model\DelegatorRewardsBaker',
        'baking_power' => 'int',
    ...
    */
     ...
     * Gets baker
     *
     * @return \Bzzhh\Tzkt\Model\DelegatorRewardsBaker|null
     */
     ...
     * Sets baker
     *
     * @param \Bzzhh\Tzkt\Model\DelegatorRewardsBaker|null $baker baker
     *
     * @return self
     */
     ...
     * @return int|null
     */
    public function getBakerDelegatedBalance()
    {
     ...
     *
     * @param int|null $baker_delegated_balance Amount delegated from the baker's own balance (micro tez). This amount doesn't include staked amount.
     *
     * @return self
     */
    public function setBakerDelegatedBalance($baker_delegated_balance)
    {
     ...
     * @return int|null
     */
    public function getBakerStakedBalance()
    {
     ...
     *
     * @param int|null $baker_staked_balance Amount staked from the baker's own balance (micro tez).
     *
     * @return self
     */
    public function setBakerStakedBalance($baker_staked_balance)
    {

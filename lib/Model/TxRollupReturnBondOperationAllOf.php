...
/**
 * TxRollupReturnBondOperationAllOf Class Doc Comment
 *
 * @category Class
 * @package  Bzzhh\Tzkt
 * @author   OpenAPI Generator team
 ...
 */
class TxRollupReturnBondOperationAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TxRollupReturnBondOperation_allOf';
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type Type of the operation, `tx_rollup_return_bond`
     *
     * @return self
     */
     ...
     * Sets rollup
     *
     * @param OneOfAlias|null $rollup Information about the rollup to which the operation was sent
     *
     * @return self
     */
     ...
     * Sets bond
     *
     * @param int|null $bond Amount of bonds unlocked (micro tez)
     *
     * @return self
     */

...
/**
 * EndorsingRewardOperationAllOf Class Doc Comment
 *
 * @category Class
 * @package  Bzzhh\Tzkt
 * @author   OpenAPI Generator team
 ...
 */
class EndorsingRewardOperationAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EndorsingRewardOperation_allOf';
    ...
    */
     ...
     * Sets baker
     *
     * @param OneOfAlias|null $baker Baker expected to receive endorsing reward
     *
     * @return self
     */

...
/**
 * TxRollupRejectionOperationAllOf Class Doc Comment
 *
 * @category Class
 * @package  Bzzhh\Tzkt
 * @author   OpenAPI Generator team
 ...
 */
class TxRollupRejectionOperationAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TxRollupRejectionOperation_allOf';
    ...
    */
     ...
     * Sets committer
     *
     * @param OneOfAlias|null $committer Information about the committer
     *
     * @return self
     */

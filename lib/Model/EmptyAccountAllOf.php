...
/**
 * EmptyAccountAllOf Class Doc Comment
 *
 * @category Class
 * @package  Bzzhh\Tzkt
 * @author   OpenAPI Generator team
 ...
 */
class EmptyAccountAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmptyAccount_allOf';
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type Type of the account, `empty` - account hasn't appeared in the blockchain yet
     *
     * @return self
     */

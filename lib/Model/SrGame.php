 ...
 */
class SrGame implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SrGame';
    ...
    protected static $openAPITypes = [
        'id' => 'int',
        'rollup' => '\Bzzhh\Tzkt\Model\SrGameRollup',
        ...
        'last_move' => '\Bzzhh\Tzkt\Model\SrGameLastMove',
        'first_level' => 'int',
        'first_time' => '\DateTime',
        'last_level' => 'int',
        'last_time' => '\DateTime',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('last_move', $data ?? [], null);
    ...
    */
     ...
     * Gets rollup
     *
     * @return \Bzzhh\Tzkt\Model\SrGameRollup|null
     */
     ...
     * Sets rollup
     *
     * @param \Bzzhh\Tzkt\Model\SrGameRollup|null $rollup rollup
     *
     * @return self
     */
     ...
     * Gets last_move
     *
     * @return \Bzzhh\Tzkt\Model\SrGameLastMove|null
     */
    public function getLastMove()
    {
        return $this->container['last_move'];
    }

    /**
     * Sets last_move
     *
     * @param \Bzzhh\Tzkt\Model\SrGameLastMove|null $last_move last_move
     *
     * @return self
     */
    public function setLastMove($last_move)
    {
        ...
        if (is_null($last_move)) {
            array_push($this->openAPINullablesSetToNull, 'last_move');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('last_move', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        $this->container['last_move'] = $last_move;
     ...
     * Sets first_level
     *
     * @param int|null $first_level Level of the block where the refutation game was started.   **[sortable]**
     *
     * @return self
     */
     ...
     * Sets first_time
     *
     * @param \DateTime|null $first_time Timestamp of the block where the refutation game was started.
     *
     * @return self
     */
     ...
     * Sets last_level
     *
     * @param int|null $last_level Level of the block where the refutation game was last updated.   **[sortable]**
     *
     * @return self
     */
     ...
     * Sets last_time
     *
     * @param \DateTime|null $last_time Timestamp of the block where the refutation game was last updated.
     *
     * @return self
     */

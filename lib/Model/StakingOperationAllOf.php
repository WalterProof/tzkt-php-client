...
/**
 * StakingOperationAllOf Class Doc Comment
 *
 * @category Class
 * @package  Bzzhh\Tzkt
 * @author   OpenAPI Generator team
 ...
 */
class StakingOperationAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StakingOperation_allOf';
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type Type of the operation, `staking`
     *
     * @return self
     */
     ...
     * Sets action
     *
     * @param string|null $action Staking action (`stake`, `unstake`, `finalize`)
     *
     * @return self
     */
     ...
     *
     * @param int|null $requested_amount Amount passed as the staking operation parameter (micro tez)
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param int|null $amount Actually processed amount (micro tez)
     *
     * @return self
     */
     ...
     * Sets baker
     *
     * @param OneOfAlias|null $baker Information about the baker
     *
     * @return self
     */
     ...
     * Sets kind
     *
     * @param string|null $kind [DEPRECATED]
     *
     * @return self
     */
     ...
     * Sets pseudotokens
     *
     * @param int|null $pseudotokens [DEPRECATED]
     *
     * @return self
     */
     ...
     *
     * @param int|null $limit_of_staking_over_baking [DEPRECATED]
     *
     * @return self
     */
     ...
     *
     * @param int|null $edge_of_baking_over_staking [DEPRECATED]
     *
     * @return self
     */
     ...
     * @return int|null
     */
    public function getActivationCycle()
    {
     ...
     *
     * @param int|null $activation_cycle [DEPRECATED]
     *
     * @return self
     */
    public function setActivationCycle($activation_cycle)
    {

<?php
/**
 * SmartRollupCementOperationAllOf
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * SmartRollupCementOperationAllOf Class Doc Comment
 *
 * @category Class
 * @package  Bzzhh\Tzkt
 * @author   OpenAPI Generator team
 ...
 */
class SmartRollupCementOperationAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SmartRollupCementOperation_allOf';
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type Type of the operation, `sr_cement`
     *
     * @return self
     */
     ...
     * Sets commitment
     *
     * @param OneOfSrCommitmentInfo|null $commitment Cemented commitment
     *
     * @return self
     */

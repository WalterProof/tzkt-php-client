...
/**
 * AutostakingOperationAllOf Class Doc Comment
 *
 * @category Class
 * @package  Bzzhh\Tzkt
 * @author   OpenAPI Generator team
 ...
 */
class AutostakingOperationAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AutostakingOperation_allOf';
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type Type of the operation, `autostaking`
     *
     * @return self
     */
     ...
     * Sets baker
     *
     * @param OneOfAlias|null $baker Baker for which autostaking event happened
     *
     * @return self
     */
     ...
     * Sets action
     *
     * @param string|null $action Autostaking action (`stake`, `unstake`, `finalize`)
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param int|null $amount Amount (micro tez)
     *
     * @return self
     */
     ...
     * Sets cycle
     *
     * @param int|null $cycle [DEPRECATED]
     *
     * @return self
     */

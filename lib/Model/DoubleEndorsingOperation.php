...
class DoubleEndorsingOperation extends Operation
{
     ...
     * Sets type
     *
     * @param string $type Type of the operation, `double_endorsing` - is used by bakers to provide evidence of double endorsement (endorsing two different blocks at the same block height) by a baker
     *
     * @return self
     */
     ...
     * Sets accused_level
     *
     * @param int|null $accused_level The height of the block from the genesis block, at which double endorsing occurred
     *
     * @return self
     */
     ...
     * Sets offender
     *
     * @param OneOfAlias|null $offender Information about the baker (delegate), accused for producing two different endorsements at the same height
     *
     * @return self
     */

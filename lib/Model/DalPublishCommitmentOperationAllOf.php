<?php
/**
 * DalPublishCommitmentOperationAllOf
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * DalPublishCommitmentOperationAllOf Class Doc Comment
 *
 * @category Class
 * @package  Bzzhh\Tzkt
 * @author   OpenAPI Generator team
 ...
 */
class DalPublishCommitmentOperationAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DalPublishCommitmentOperation_allOf';
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type Type of the operation, `dal_publish_commitment`
     *
     * @return self
     */
     ...
     * Sets commitment
     *
     * @param string|null $commitment Commitment hash
     *
     * @return self
     */

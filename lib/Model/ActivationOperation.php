...
class ActivationOperation extends Operation
{
     ...
     * Sets type
     *
     * @param string $type Type of the operation, `activation` - is used to activate accounts that were recommended allocations of tezos tokens for donations to the Tezos Foundation’s fundraiser.
     *
     * @return self
     */

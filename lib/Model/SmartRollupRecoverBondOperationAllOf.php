<?php
/**
 * SmartRollupRecoverBondOperationAllOf
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * SmartRollupRecoverBondOperationAllOf Class Doc Comment
 *
 * @category Class
 * @package  Bzzhh\Tzkt
 * @author   OpenAPI Generator team
 ...
 */
class SmartRollupRecoverBondOperationAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SmartRollupRecoverBondOperation_allOf';
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type Type of the operation, `sr_recover_bond`
     *
     * @return self
     */
     ...
     * Sets staker
     *
     * @param OneOfAlias|null $staker Staker account, which's bond should be returned
     *
     * @return self
     */
     ...
     * Sets bond
     *
     * @param int|null $bond Amount of bonds returned (micro tez)
     *
     * @return self
     */

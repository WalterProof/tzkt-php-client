<?php
/**
 * IncreasePaidStorageOperationAllOf
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * IncreasePaidStorageOperationAllOf Class Doc Comment
 *
 * @category Class
 * @package  Bzzhh\Tzkt
 * @author   OpenAPI Generator team
 ...
 */
class IncreasePaidStorageOperationAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IncreasePaidStorageOperation_allOf';
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type Type of the operation, `increase_paid_storage`
     *
     * @return self
     */
     ...
     * Sets contract
     *
     * @param OneOfAlias|null $contract Information about the contract for which paid storage was increased
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param string|null $amount Amount of storage in bytes prepaid.
     *
     * @return self
     */

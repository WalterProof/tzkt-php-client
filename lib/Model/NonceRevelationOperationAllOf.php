...
/**
 * NonceRevelationOperationAllOf Class Doc Comment
 *
 * @category Class
 * @package  Bzzhh\Tzkt
 * @author   OpenAPI Generator team
 ...
 */
class NonceRevelationOperationAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NonceRevelationOperation_allOf';
    ...
    */
     ...
     * Sets sender
     *
     * @param OneOfAlias|null $sender Information about the delegate (baker), who revealed the nonce (sent the operation)
     *
     * @return self
     */
     ...
     * @return int|null
     */
    public function getRevealedLevel()
    {
     ...
     * @return self
     */
    public function setRevealedLevel($revealed_level)
    {
     ...
     * @return int|null
     */
    public function getRevealedCycle()
    {
     ...
     * @return self
     */
    public function setRevealedCycle($revealed_cycle)
    {
     ...
     * @return int|null
     */
    public function getBakerRewards()
    {
     ...
     * @return self
     */
    public function setBakerRewards($baker_rewards)
    {

...
class TicketTransfer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TicketTransfer';
    ...
    protected static $openAPITypes = [
        ...
        'to' => '\Bzzhh\Tzkt\Model\TicketTransferTo',
        'amount' => 'string',
        'transaction_id' => 'int',
    ...
    */
     ...
     * Gets to
     *
     * @return \Bzzhh\Tzkt\Model\TicketTransferTo|null
     */
     ...
     * Sets to
     *
     * @param \Bzzhh\Tzkt\Model\TicketTransferTo|null $to to
     *
     * @return self
     */
     ...
     * @return int|null
     */
    public function getSmartRollupExecuteId()
    {
     ...
     * @return self
     */
    public function setSmartRollupExecuteId($smart_rollup_execute_id)
    {

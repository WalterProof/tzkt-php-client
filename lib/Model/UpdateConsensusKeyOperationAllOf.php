<?php
/**
 * UpdateConsensusKeyOperationAllOf
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * UpdateConsensusKeyOperationAllOf Class Doc Comment
 *
 * @category Class
 * @package  Bzzhh\Tzkt
 * @author   OpenAPI Generator team
 ...
 */
class UpdateConsensusKeyOperationAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateConsensusKeyOperation_allOf';
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type Type of the operation, `update_consensus_key`
     *
     * @return self
     */
     ...
     *
     * @param int|null $activation_cycle Index of the cycle from which the consensus key will be active
     *
     * @return self
     */
    public function setActivationCycle($activation_cycle)
    {
        ...
        if (is_null($activation_cycle)) {
            throw new \InvalidArgumentException('non-nullable activation_cycle cannot be null');
        }
     ...
     * Sets public_key
     *
     * @param string|null $public_key Consensus key
     *
     * @return self
     */
     ...
     *
     * @param string|null $public_key_hash Consensus key hash
     *
     * @return self
     */
    public function setPublicKeyHash($public_key_hash)
    {
        ...
        if (is_null($public_key_hash)) {
            array_push($this->openAPINullablesSetToNull, 'public_key_hash');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('public_key_hash', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }

...
/**
 * TransferTicketOperationAllOf Class Doc Comment
 *
 * @category Class
 * @package  Bzzhh\Tzkt
 * @author   OpenAPI Generator team
 ...
 */
class TransferTicketOperationAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransferTicketOperation_allOf';
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type Type of the operation, `transfer_ticket`
     *
     * @return self
     */
     ...
     * Sets target
     *
     * @param OneOfAlias|null $target Information about the target to which the operation was sent
     *
     * @return self
     */
     ...
     * Sets ticketer
     *
     * @param OneOfAlias|null $ticketer Information about the ticketer
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param string|null $amount Amount sent
     *
     * @return self
     */
     ...
     * Sets content_type
     *
     * @param mixed|null $content_type Micheline type of the content
     *
     * @return self
     */
     ...
     * Sets content
     *
     * @param mixed|null $content Ticket content
     *
     * @return self
     */

...
/**
 * EventInterface Class Doc Comment
 *
 * @category Class
 * @package  Bzzhh\Tzkt
 * @author   OpenAPI Generator team
 ...
 */
class EventInterface implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EventInterface';
    ...
    */
     ...
     * Sets event_schema
     *
     * @param mixed|null $event_schema JSON Schema of the event type in humanified format (as returned by API)
     *
     * @return self
     */

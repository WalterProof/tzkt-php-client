...
/**
 * MigrationOperationAllOf Class Doc Comment
 *
 * @category Class
 * @package  Bzzhh\Tzkt
 * @author   OpenAPI Generator team
...
class MigrationOperationAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MigrationOperation_allOf';
    ...
    */
     ...
     * Sets account
     *
     * @param OneOfAlias|null $account Information about the account whose balance has updated as a result of the operation
     *
     * @return self
     */

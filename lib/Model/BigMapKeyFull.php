...
/**
 * BigMapKeyFull Class Doc Comment
 *
 * @category Class
 * @package  Bzzhh\Tzkt
 * @author   OpenAPI Generator team
 ...
 */
class BigMapKeyFull implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BigMapKeyFull';
    ...
    */
     ...
     * Sets active
     *
     * @param bool|null $active Key status (`true` - active, `false` - removed).
     *
     * @return self
     */
     ...
     * Sets hash
     *
     * @param string|null $hash Key hash.
     *
     * @return self
     */
     ...
     * Sets key
     *
     * @param mixed|null $key Key in JSON or Micheline format, depending on the `micheline` query parameter.   **[sortable]**
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param mixed|null $value Value in JSON or Micheline format, depending on the `micheline` query parameter. Note, if the key is inactive (removed) this field will contain the last non-null value.   **[sortable]**
     *
     * @return self
     */
     ...
     * Sets first_level
     *
     * @param int|null $first_level Level of the block where the key was first seen.   **[sortable]**
     *
     * @return self
     */
     ...
     * Sets first_time
     *
     * @param \DateTime|null $first_time Timestamp of the block where the key was first seen.
     *
     * @return self
     */
     ...
     * Sets last_level
     *
     * @param int|null $last_level Level of the block where the key was last seen.   **[sortable]**
     *
     * @return self
     */
     ...
     * Sets last_time
     *
     * @param \DateTime|null $last_time Timestamp of the block where the key was last seen.
     *
     * @return self
     */
     ...
     * Sets updates
     *
     * @param int|null $updates Total number of actions with the key.   **[sortable]**
     *
     * @return self
     */

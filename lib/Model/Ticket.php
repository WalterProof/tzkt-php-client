...
class Ticket implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'id' => 'int',
        'ticketer' => '\Bzzhh\Tzkt\Model\TicketTicketer',
        'raw_type' => '\Bzzhh\Tzkt\Model\TicketRawType',
        'raw_content' => '\Bzzhh\Tzkt\Model\TicketRawContent',
        'content' => 'mixed',
        'type_hash' => 'int',
        'content_hash' => 'int',
        'first_minter' => '\Bzzhh\Tzkt\Model\TicketFirstMinter',
        'first_level' => 'int',
        'first_time' => '\DateTime',
        'last_level' => 'int',
        'last_time' => '\DateTime',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('ticketer', $data ?? [], null);
        $this->setIfExists('raw_type', $data ?? [], null);
        $this->setIfExists('raw_content', $data ?? [], null);
    ...
    */
     ...
     * Gets ticketer
     *
     * @return \Bzzhh\Tzkt\Model\TicketTicketer|null
     */
    public function getTicketer()
    {
        return $this->container['ticketer'];
    }

    /**
     * Sets ticketer
     *
     * @param \Bzzhh\Tzkt\Model\TicketTicketer|null $ticketer ticketer
     *
     * @return self
     */
    public function setTicketer($ticketer)
    {

        if (is_null($ticketer)) {
            array_push($this->openAPINullablesSetToNull, 'ticketer');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('ticketer', $nullablesSetToNull);
            if ($index !== FALSE) {
        ...
        $this->container['ticketer'] = $ticketer;
     ...
     * Gets raw_type
     *
     * @return \Bzzhh\Tzkt\Model\TicketRawType|null
     */
     ...
     * Sets raw_type
     *
     * @param \Bzzhh\Tzkt\Model\TicketRawType|null $raw_type raw_type
     *
     * @return self
     */
     ...
     * Gets raw_content
     *
     * @return \Bzzhh\Tzkt\Model\TicketRawContent|null
     */
     ...
     * Sets raw_content
     *
     * @param \Bzzhh\Tzkt\Model\TicketRawContent|null $raw_content raw_content
     *
     * @return self
     */
    public function setRawContent($raw_content)
    {
        ...
        if (is_null($raw_content)) {
            array_push($this->openAPINullablesSetToNull, 'raw_content');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('raw_content', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets content
     *
     * @param mixed|null $content Ticket content in JSON format.
     *
     * @return self
     */
     ...
     * Sets type_hash
     *
     * @param int|null $type_hash 32-bit hash of the ticket content type.
     *
     * @return self
     */
     ...
     * Sets content_hash
     *
     * @param int|null $content_hash 32-bit hash of the ticket content.
     *
     * @return self
     */
     ...
     * Gets first_minter
     *
     * @return \Bzzhh\Tzkt\Model\TicketFirstMinter|null
     */
     ...
     * Sets first_minter
     *
     * @param \Bzzhh\Tzkt\Model\TicketFirstMinter|null $first_minter first_minter
     *
     * @return self
     */
     ...
     * Sets first_level
     *
     * @param int|null $first_level Level of the block where the ticket was first seen.   **[sortable]**
     *
     * @return self
     */
     ...
     * Sets first_time
     *
     * @param \DateTime|null $first_time Timestamp of the block where the ticket was first seen.
     *
     * @return self
     */
     ...
     * Sets last_level
     *
     * @param int|null $last_level Level of the block where the ticket was last seen.   **[sortable]**
     *
     * @return self
     */
     ...
     * Sets last_time
     *
     * @param \DateTime|null $last_time Timestamp of the block where the ticket was last seen.
     *
     * @return self
     */
     ...
     * Sets total_minted
     *
     * @param string|null $total_minted Total amount minted.
     *
     * @return self
     */
     ...
     * Sets total_burned
     *
     * @param string|null $total_burned Total amount burned.
     *
     * @return self
     */
     ...
     * Sets total_supply
     *
     * @param string|null $total_supply Total amount exists.
     *
     * @return self
     */

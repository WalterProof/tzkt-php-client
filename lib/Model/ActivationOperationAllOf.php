...
/**
 * ActivationOperationAllOf Class Doc Comment
 *
 * @category Class
 * @package  Bzzhh\Tzkt
 * @author   OpenAPI Generator team
 ...
 */
class ActivationOperationAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ActivationOperation_allOf';
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type Type of the operation, `activation` - is used to activate accounts that were recommended allocations of tezos tokens for donations to the Tezos Foundation’s fundraiser.
     *
     * @return self
     */
     ...
     * Sets balance
     *
     * @param int|null $balance Account activation balance of tezos tokens that were recommended allocations for donations to the Tezos Foundation’s fundraiser
     *
     * @return self
     */

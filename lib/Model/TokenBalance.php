...
class TokenBalance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'id' => 'int',
        'account' => '\Bzzhh\Tzkt\Model\TicketBalanceAccount',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('balance_value', $data ?? [], null);
    ...
    */
     ...
     * Gets account
     *
     * @return \Bzzhh\Tzkt\Model\TicketBalanceAccount|null
     */
     ...
     * Sets account
     *
     * @param \Bzzhh\Tzkt\Model\TicketBalanceAccount|null $account account
     *
     * @return self
     */
    ...
    {
        return $this->container['balance_value'];
    }

    /**
     * Sets balance_value
     *
     * @param string|null $balance_value Balance value in mutez, based on the current token price.   **[sortable]**
     *
     * @return self
     */
    public function setBalanceValue($balance_value)
    {

        if (is_null($balance_value)) {
            array_push($this->openAPINullablesSetToNull, 'balance_value');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('balance_value', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        $this->container['balance_value'] = $balance_value;

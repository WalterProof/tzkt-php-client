...
/**
 * ProtocolMetadata Class Doc Comment
 *
 * @category Class
 ...
 */
class ProtocolMetadata implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Protocol_metadata';
    ...
    */
     ...
     * Sets alias
     *
     * @param string|null $alias Protocol name
     *
     * @return self
     */
     ...
     * Sets hash
     *
     * @param string|null $hash Protocol hash
     *
     * @return self
     */
     ...
     * Sets docs
     *
     * @param string|null $docs Link to the documentation with explanation of the protocol and changes
     *
     * @return self
     */
    public function setDocs($docs)
    {
        ...
        if (is_null($docs)) {
            array_push($this->openAPINullablesSetToNull, 'docs');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('docs', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }

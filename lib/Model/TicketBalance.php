...
/**
 * TicketBalance Class Doc Comment
 *
 * @category Class
 * @package  Bzzhh\Tzkt
 * @author   OpenAPI Generator team
 ...
 */
class TicketBalance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TicketBalance';
    ...
    protected static $openAPITypes = [
        'id' => 'int',
        'ticket' => '\Bzzhh\Tzkt\Model\TicketBalanceTicket',
    ...
    */
     ...
     * Gets ticket
     *
     * @return \Bzzhh\Tzkt\Model\TicketBalanceTicket|null
     */
     ...
     * Sets ticket
     *
     * @param \Bzzhh\Tzkt\Model\TicketBalanceTicket|null $ticket ticket
     *
     * @return self
     */
     ...
     * Sets balance
     *
     * @param string|null $balance Balance.   **[sortable]**
     *
     * @return self
     */
     ...
     *
     * @param int|null $transfers_count Total number of transfers, affecting the ticket balance.   **[sortable]**
     *
     * @return self
     */
     ...
     * Sets first_level
     *
     * @param int|null $first_level Level of the block where the ticket balance was first changed.   **[sortable]**
     *
     * @return self
     */
     ...
     * Sets first_time
     *
     * @param \DateTime|null $first_time Timestamp of the block where the ticket balance was first changed.
     *
     * @return self
     */
     ...
     * Sets last_level
     *
     * @param int|null $last_level Level of the block where the ticket balance was last changed.   **[sortable]**
     *
     * @return self
     */
     ...
     * Sets last_time
     *
     * @param \DateTime|null $last_time Timestamp of the block where the ticket balance was last changed.
     *
     * @return self
     */

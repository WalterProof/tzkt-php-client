...
class Delegator implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
		...
		'address' => true,
		'balance' => false,
		'delegation_level' => false,
		'delegation_time' => false
    ];
    ...
    */
    ...
    public function setDelegationLevel($delegation_level)
    {
        ...
        if (is_null($delegation_level)) {
            throw new \InvalidArgumentException('non-nullable delegation_level cannot be null');
        }
    ...
    public function setDelegationTime($delegation_time)
    {
        ...
        if (is_null($delegation_time)) {
            throw new \InvalidArgumentException('non-nullable delegation_time cannot be null');
        }

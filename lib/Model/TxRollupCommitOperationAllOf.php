...
/**
 * TxRollupCommitOperationAllOf Class Doc Comment
 *
 * @category Class
 * @package  Bzzhh\Tzkt
 * @author   OpenAPI Generator team
 ...
 */
class TxRollupCommitOperationAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TxRollupCommitOperation_allOf';
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type Type of the operation, `tx_rollup_commit`
     *
     * @return self
     */
     ...
     * Sets bond
     *
     * @param int|null $bond Amount of bonds (micro tez) locked
     *
     * @return self
     */

<?php
/**
 * DoublePreendorsingOperationAllOf
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * DoublePreendorsingOperationAllOf Class Doc Comment
 *
 * @category Class
 * @package  Bzzhh\Tzkt
 * @author   OpenAPI Generator team
 ...
 */
class DoublePreendorsingOperationAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DoublePreendorsingOperation_allOf';
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type Type of the operation, `double_preendorsing`
     *
     * @return self
     */
     ...
     * Sets accused_level
     *
     * @param int|null $accused_level Height of the block from the genesis, at which double preendorsing occurred
     *
     * @return self
     */
     ...
     * Sets offender
     *
     * @param OneOfAlias|null $offender Information about the baker, accused for producing two different preendorsements at the same level
     *
     * @return self
     */

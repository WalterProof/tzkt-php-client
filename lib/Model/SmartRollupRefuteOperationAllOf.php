...
/**
 * SmartRollupRefuteOperationAllOf Class Doc Comment
 *
 * @category Class
 * @package  Bzzhh\Tzkt
 * @author   OpenAPI Generator team
 ...
 */
class SmartRollupRefuteOperationAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SmartRollupRefuteOperation_allOf';
    ...
    protected static $openAPITypes = [
        ...
        'status' => 'string',
        'rollup' => 'OneOfAlias',
        'game' => 'OneOfSrGameInfo',
        'move' => 'string',
        'game_status' => 'string',
        'dissection_start' => 'int',
        'dissection_end' => 'int',
        'dissection_steps' => 'int',
    ...
    protected static $openAPIFormats = [
        ...
        'move' => null,
        'game_status' => null,
        'dissection_start' => 'int64',
        'dissection_end' => 'int64',
        'dissection_steps' => 'int32',
        'errors' => null,
        'quote' => null
    ];
    ...
    protected static array $openAPINullables = [
		...
		'move' => true,
		'game_status' => true,
		'dissection_start' => true,
		'dissection_end' => true,
		'dissection_steps' => true,
		'errors' => true,
		'quote' => true
    ];
    ...
    protected static $attributeMap = [
        ...
        'dissection_start' => 'dissectionStart',
        'dissection_end' => 'dissectionEnd',
        'dissection_steps' => 'dissectionSteps',
        'errors' => 'errors',
        'quote' => 'quote'
    ];
    ...
    protected static $setters = [
        ...
        'dissection_start' => 'setDissectionStart',
        'dissection_end' => 'setDissectionEnd',
        'dissection_steps' => 'setDissectionSteps',
        'errors' => 'setErrors',
        'quote' => 'setQuote'
    ];
    ...
    protected static $getters = [
        ...
        'dissection_start' => 'getDissectionStart',
        'dissection_end' => 'getDissectionEnd',
        'dissection_steps' => 'getDissectionSteps',
        'errors' => 'getErrors',
        'quote' => 'getQuote'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('dissection_start', $data ?? [], null);
        $this->setIfExists('dissection_end', $data ?? [], null);
        $this->setIfExists('dissection_steps', $data ?? [], null);
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type Type of the operation, `sr_refute`
     *
     * @return self
     */
     ...
     * Sets game
     *
     * @param OneOfSrGameInfo|null $game Refutation game info
     *
     * @return self
     */
     ...
     * Sets game_status
     *
     * @param string|null $game_status Game status, after player's move (`ongoing`, `loser`, `draw`)
     *
     * @return self
     */
    ...
    /**
     * Gets dissection_start
     *
     * @return int|null
     */
    public function getDissectionStart()
    {
        return $this->container['dissection_start'];
    }

    /**
     * Sets dissection_start
     *
     * @param int|null $dissection_start The first tick in the dissection range. This field is `null` if `move` is not `dissection.
     *
     * @return self
     */
    public function setDissectionStart($dissection_start)
    {

        if (is_null($dissection_start)) {
            array_push($this->openAPINullablesSetToNull, 'dissection_start');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('dissection_start', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        $this->container['dissection_start'] = $dissection_start;
     ...
     * @return int|null
     */
    public function getDissectionEnd()
    {
        return $this->container['dissection_end'];
    }

    /**
     * Sets dissection_end
     *
     * @param int|null $dissection_end The last tick in the dissection range. This field is `null` if `move` is not `dissection.
     *
     * @return self
     */
    public function setDissectionEnd($dissection_end)
    {

        if (is_null($dissection_end)) {
            array_push($this->openAPINullablesSetToNull, 'dissection_end');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('dissection_end', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        $this->container['dissection_end'] = $dissection_end;

        return $this;
    }

    /**
     * Gets dissection_steps
     *
     * @return int|null
     */
    public function getDissectionSteps()
    {
        return $this->container['dissection_steps'];
    }

    /**
     * Sets dissection_steps
     *
     * @param int|null $dissection_steps Total ticks in the dissection range. This field is `null` if `move` is not `dissection`.
     *
     * @return self
     */
    public function setDissectionSteps($dissection_steps)
    {

        if (is_null($dissection_steps)) {
            array_push($this->openAPINullablesSetToNull, 'dissection_steps');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('dissection_steps', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        $this->container['dissection_steps'] = $dissection_steps;

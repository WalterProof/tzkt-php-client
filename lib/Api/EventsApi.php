...
/**
     ...
     * @param  BigMapsGetBigMapKeysFirstTimeParameter $timestamp Filter by timestamp (ISO 8601) of the block where the event was emitted.   Click on the parameter to expand more details. (optional)

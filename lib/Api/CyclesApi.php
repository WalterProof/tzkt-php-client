...
/**
     ...
     */
    public function cyclesGet($select = null, $sort = null, $offset = null, $limit = 100, $quote = null, string $contentType = self::contentTypes['cyclesGet'][0])
    {
        list($response) = $this->cyclesGetWithHttpInfo($select, $sort, $offset, $limit, $quote, $contentType);
        return $response;
    }
     ...
     */
    public function cyclesGetWithHttpInfo($select = null, $sort = null, $offset = null, $limit = 100, $quote = null, string $contentType = self::contentTypes['cyclesGet'][0])
    {
        $request = $this->cyclesGetRequest($select, $sort, $offset, $limit, $quote, $contentType);
     ...
     */
    public function cyclesGetAsync($select = null, $sort = null, $offset = null, $limit = 100, $quote = null, string $contentType = self::contentTypes['cyclesGet'][0])
    {
        return $this->cyclesGetAsyncWithHttpInfo($select, $sort, $offset, $limit, $quote, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cyclesGetAsyncWithHttpInfo($select = null, $sort = null, $offset = null, $limit = 100, $quote = null, string $contentType = self::contentTypes['cyclesGet'][0])
    {
        $returnType = '\Bzzhh\Tzkt\Model\Cycle[]';
        $request = $this->cyclesGetRequest($select, $sort, $offset, $limit, $quote, $contentType);
     ...
     */
    public function cyclesGetRequest($select = null, $sort = null, $offset = null, $limit = 100, $quote = null, string $contentType = self::contentTypes['cyclesGet'][0])
    {

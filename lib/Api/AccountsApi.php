...
/**
     ...
     * @param  AccountsGetTypeParameter $type Filters accounts by type (&#x60;user&#x60;, &#x60;delegate&#x60;, &#x60;contract&#x60;, &#x60;ghost&#x60;). (optional)
     ...
     * @return \Bzzhh\Tzkt\Model\Account
     */
    public function accountsGetByAddress($address, $metadata = false, string $contentType = self::contentTypes['accountsGetByAddress'][0])
    {
        list($response) = $this->accountsGetByAddressWithHttpInfo($address, $metadata, $contentType);
        return $response;
    }
     ...
     * @return array of \Bzzhh\Tzkt\Model\Account, HTTP status code, HTTP response headers (array of strings)
     */
    public function accountsGetByAddressWithHttpInfo($address, $metadata = false, string $contentType = self::contentTypes['accountsGetByAddress'][0])
    {
        $request = $this->accountsGetByAddressRequest($address, $metadata, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function accountsGetByAddressAsync($address, $metadata = false, string $contentType = self::contentTypes['accountsGetByAddress'][0])
    {
        return $this->accountsGetByAddressAsyncWithHttpInfo($address, $metadata, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function accountsGetByAddressAsyncWithHttpInfo($address, $metadata = false, string $contentType = self::contentTypes['accountsGetByAddress'][0])
    {
        $returnType = '\Bzzhh\Tzkt\Model\Account';
        $request = $this->accountsGetByAddressRequest($address, $metadata, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function accountsGetByAddressRequest($address, $metadata = false, string $contentType = self::contentTypes['accountsGetByAddress'][0])
    {
     ...
     * @param  AccountsGetTypeParameter $type Filters delegators by type (&#x60;user&#x60;, &#x60;delegate&#x60;, &#x60;contract&#x60;, &#x60;ghost&#x60;). (optional)
     ...
     *
     * @param  string $address Account address (starting with tz or KT) (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['accountsGetMetadata'] to see the possible values for this operation
     *
     * @throws \Bzzhh\Tzkt\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Bzzhh\Tzkt\Model\ProfileMetadata
     */
    public function accountsGetMetadata($address, string $contentType = self::contentTypes['accountsGetMetadata'][0])
    {
        list($response) = $this->accountsGetMetadataWithHttpInfo($address, $contentType);
        return $response;
    }
     ...
     * @throws \Bzzhh\Tzkt\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Bzzhh\Tzkt\Model\ProfileMetadata, HTTP status code, HTTP response headers (array of strings)
     */
    public function accountsGetMetadataWithHttpInfo($address, string $contentType = self::contentTypes['accountsGetMetadata'][0])
    {
        $request = $this->accountsGetMetadataRequest($address, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Bzzhh\Tzkt\Model\ProfileMetadata' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Bzzhh\Tzkt\Model\ProfileMetadata' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Bzzhh\Tzkt\Model\ProfileMetadata', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Bzzhh\Tzkt\Model\ProfileMetadata';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Bzzhh\Tzkt\Model\ProfileMetadata',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function accountsGetMetadataAsync($address, string $contentType = self::contentTypes['accountsGetMetadata'][0])
    {
        return $this->accountsGetMetadataAsyncWithHttpInfo($address, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function accountsGetMetadataAsyncWithHttpInfo($address, string $contentType = self::contentTypes['accountsGetMetadata'][0])
    {
        $returnType = '\Bzzhh\Tzkt\Model\ProfileMetadata';
        $request = $this->accountsGetMetadataRequest($address, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function accountsGetMetadataRequest($address, string $contentType = self::contentTypes['accountsGetMetadata'][0])
    {

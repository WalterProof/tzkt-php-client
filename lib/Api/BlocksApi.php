...
class BlocksApi
{
     ...
     * Get blocks
     *
     * @param  OneOfAccountParameter $baker Filters blocks by baker. Allowed fields for &#x60;.eqx&#x60; mode: none. (optional)
     * @param  OneOfInt32Parameter $level Filters blocks by level. (optional)
     * @param  OneOfDateTimeParameter $timestamp Filters blocks by timestamp. (optional)
     * @param  OneOfInt32Parameter $priority Filters blocks by priority. (optional)
     ...
     * @param  OneOfSortParameter $sort Sorts blocks by specified field. Supported fields: &#x60;id&#x60; (default), &#x60;level&#x60;, &#x60;priority&#x60;, &#x60;validations&#x60;, &#x60;reward&#x60;, &#x60;fees&#x60;. (optional)
     ...
     */
    public function blocksGet($baker = null, $level = null, $timestamp = null, $priority = null, $select = null, $sort = null, $offset = null, $limit = 100, $quote = null)
    {
        list($response) = $this->blocksGetWithHttpInfo($baker, $level, $timestamp, $priority, $select, $sort, $offset, $limit, $quote);
        return $response;
    }
     ...
     */
    public function blocksGetWithHttpInfo($baker = null, $level = null, $timestamp = null, $priority = null, $select = null, $sort = null, $offset = null, $limit = 100, $quote = null)
    {
        $request = $this->blocksGetRequest($baker, $level, $timestamp, $priority, $select, $sort, $offset, $limit, $quote);
     ...
     */
    public function blocksGetAsync($baker = null, $level = null, $timestamp = null, $priority = null, $select = null, $sort = null, $offset = null, $limit = 100, $quote = null)
    {
        return $this->blocksGetAsyncWithHttpInfo($baker, $level, $timestamp, $priority, $select, $sort, $offset, $limit, $quote)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function blocksGetAsyncWithHttpInfo($baker = null, $level = null, $timestamp = null, $priority = null, $select = null, $sort = null, $offset = null, $limit = 100, $quote = null)
    {
        $returnType = '\Bzzhh\Tzkt\Model\Block[]';
        $request = $this->blocksGetRequest($baker, $level, $timestamp, $priority, $select, $sort, $offset, $limit, $quote);
     ...
     */
    public function blocksGetRequest($baker = null, $level = null, $timestamp = null, $priority = null, $select = null, $sort = null, $offset = null, $limit = 100, $quote = null)
    {
     ...
     * @return \Bzzhh\Tzkt\Model\Block
     */
    public function blocksGetByHash($hash, $operations = false, $micheline = null, $quote = null)
    {
        list($response) = $this->blocksGetByHashWithHttpInfo($hash, $operations, $micheline, $quote);
        return $response;
    }
     ...
     * @return array of \Bzzhh\Tzkt\Model\Block, HTTP status code, HTTP response headers (array of strings)
     */
    public function blocksGetByHashWithHttpInfo($hash, $operations = false, $micheline = null, $quote = null)
    {
        $request = $this->blocksGetByHashRequest($hash, $operations, $micheline, $quote);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function blocksGetByHashAsync($hash, $operations = false, $micheline = null, $quote = null)
    {
        return $this->blocksGetByHashAsyncWithHttpInfo($hash, $operations, $micheline, $quote)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function blocksGetByHashAsyncWithHttpInfo($hash, $operations = false, $micheline = null, $quote = null)
    {
        $returnType = '\Bzzhh\Tzkt\Model\Block';
        $request = $this->blocksGetByHashRequest($hash, $operations, $micheline, $quote);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function blocksGetByHashRequest($hash, $operations = false, $micheline = null, $quote = null)
    {
        ...
        // query params
        if ($operations !== null) {
            if('form' === 'form' && is_array($operations)) {
     ...
     * @return \Bzzhh\Tzkt\Model\Block
     */
    public function blocksGetByLevel($level, $operations = false, $micheline = null, $quote = null)
    {
        list($response) = $this->blocksGetByLevelWithHttpInfo($level, $operations, $micheline, $quote);
        return $response;
    }
     ...
     * @return array of \Bzzhh\Tzkt\Model\Block, HTTP status code, HTTP response headers (array of strings)
     */
    public function blocksGetByLevelWithHttpInfo($level, $operations = false, $micheline = null, $quote = null)
    {
        $request = $this->blocksGetByLevelRequest($level, $operations, $micheline, $quote);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function blocksGetByLevelAsync($level, $operations = false, $micheline = null, $quote = null)
    {
        return $this->blocksGetByLevelAsyncWithHttpInfo($level, $operations, $micheline, $quote)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function blocksGetByLevelAsyncWithHttpInfo($level, $operations = false, $micheline = null, $quote = null)
    {
        $returnType = '\Bzzhh\Tzkt\Model\Block';
        $request = $this->blocksGetByLevelRequest($level, $operations, $micheline, $quote);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function blocksGetByLevelRequest($level, $operations = false, $micheline = null, $quote = null)
    {
    ...
    {
        list($response) = $this->blocksGetCountWithHttpInfo();
        return $response;
    }
    ...
    {
        $request = $this->blocksGetCountRequest();
    ...
    {
        return $this->blocksGetCountAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }

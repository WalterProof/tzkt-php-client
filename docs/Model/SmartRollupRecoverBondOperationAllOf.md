...
------------ | ------------- | ------------- | -------------
**type** | **string** | Type of the operation, &#x60;sr_recover_bond&#x60; | [optional]
...
**staker** | [**OneOfAlias**](OneOfAlias.md) | Staker account, which&#39;s bond should be returned | [optional]
**bond** | **int** | Amount of bonds returned (micro tez) | [optional]

...
**frozen_deposit** | **int** | Amount of security deposit, currently locked for baked (produced) blocks and (or) given endorsements (micro tez) | [optional]
...
**update_consensus_key_count** | **int** | Number of &#x60;update_consensus_key&#x60; operations sent by the acount | [optional]
...
**metadata** | [**OneOfProfileMetadata**](OneOfProfileMetadata.md) | Metadata of the delegate (alias, logo, website, contacts, etc) | [optional]

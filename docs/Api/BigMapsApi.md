...
$id = 56; // int | Bigmap Id
$micheline = new \Bzzhh\Tzkt\Model\OneOfMichelineFormat(); // OneOfMichelineFormat | Format of the bigmap key and value type: `0` - JSON, `2` - Micheline
...
------------- | ------------- | ------------- | -------------
 **id** | **int**| Bigmap Id |
 **micheline** | [**OneOfMichelineFormat**](../Model/.md)| Format of the bigmap key and value type: &#x60;0&#x60; - JSON, &#x60;2&#x60; - Micheline | [optional]
...
```php
bigMapsGetBigMapUpdates($bigmap, $path, $contract, $tags, $action, $value, $level, $sort, $offset, $limit, $micheline): \Bzzhh\Tzkt\Model\BigMapUpdate[]
```
...
$bigmap = new \Bzzhh\Tzkt\Model\OneOfInt32Parameter(); // OneOfInt32Parameter | Filters updates by bigmap ptr
$path = new \Bzzhh\Tzkt\Model\OneOfStringParameter(); // OneOfStringParameter | Filters updates by bigmap path
$contract = new \Bzzhh\Tzkt\Model\OneOfAccountParameter(); // OneOfAccountParameter | Filters updates by bigmap contract
$tags = new \Bzzhh\Tzkt\Model\OneOfBigMapTagsParameter(); // OneOfBigMapTagsParameter | Filters updates by bigmap tags: `token_metadata` - tzip-12, `metadata` - tzip-16
$action = new \Bzzhh\Tzkt\Model\OneOfBigMapActionParameter(); // OneOfBigMapActionParameter | Filters updates by action
$value = new \Bzzhh\Tzkt\Model\OneOfJsonParameter(); // OneOfJsonParameter | Filters updates by JSON value. Note, this query parameter supports the following format: `?value{.path?}{.mode?}=...`,             so you can specify a path to a particular field to filter by, for example: `?value.balance.gt=...`.
$level = new \Bzzhh\Tzkt\Model\OneOfInt32Parameter(); // OneOfInt32Parameter | Filters updates by level
$sort = new \Bzzhh\Tzkt\Model\OneOfSortParameter(); // OneOfSortParameter | Sorts bigmaps by specified field. Supported fields: `id` (default), `ptr`, `firstLevel`, `lastLevel`, `totalKeys`, `activeKeys`, `updates`.
...
try {
    $result = $apiInstance->bigMapsGetBigMapUpdates($bigmap, $path, $contract, $tags, $action, $value, $level, $sort, $offset, $limit, $micheline);
    print_r($result);
} catch (Exception $e) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **bigmap** | [**OneOfInt32Parameter**](../Model/.md)| Filters updates by bigmap ptr | [optional]
 **path** | [**OneOfStringParameter**](../Model/.md)| Filters updates by bigmap path | [optional]
 **contract** | [**OneOfAccountParameter**](../Model/.md)| Filters updates by bigmap contract | [optional]
 **tags** | [**OneOfBigMapTagsParameter**](../Model/.md)| Filters updates by bigmap tags: &#x60;token_metadata&#x60; - tzip-12, &#x60;metadata&#x60; - tzip-16 | [optional]
 **action** | [**OneOfBigMapActionParameter**](../Model/.md)| Filters updates by action | [optional]
 **value** | [**OneOfJsonParameter**](../Model/.md)| Filters updates by JSON value. Note, this query parameter supports the following format: &#x60;?value{.path?}{.mode?}&#x3D;...&#x60;,             so you can specify a path to a particular field to filter by, for example: &#x60;?value.balance.gt&#x3D;...&#x60;. | [optional]
 **level** | [**OneOfInt32Parameter**](../Model/.md)| Filters updates by level | [optional]
 **sort** | [**OneOfSortParameter**](../Model/.md)| Sorts bigmaps by specified field. Supported fields: &#x60;id&#x60; (default), &#x60;ptr&#x60;, &#x60;firstLevel&#x60;, &#x60;lastLevel&#x60;, &#x60;totalKeys&#x60;, &#x60;activeKeys&#x60;, &#x60;updates&#x60;. | [optional]
...
$contract = new \Bzzhh\Tzkt\Model\OneOfAccountParameter(); // OneOfAccountParameter | Filters bigmaps by smart contract address.
$path = new \Bzzhh\Tzkt\Model\OneOfStringParameter(); // OneOfStringParameter | Filters bigmaps by path in the contract storage.
$tags = new \Bzzhh\Tzkt\Model\OneOfBigMapTagsParameter(); // OneOfBigMapTagsParameter | Filters bigmaps by tags: `token_metadata` - tzip-12, `metadata` - tzip-16.
$active = True; // bool | Filters bigmaps by status: `true` - active, `false` - removed.
$last_level = new \Bzzhh\Tzkt\Model\OneOfInt32Parameter(); // OneOfInt32Parameter | Filters bigmaps by the last update level.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **contract** | [**OneOfAccountParameter**](../Model/.md)| Filters bigmaps by smart contract address. | [optional]
 **path** | [**OneOfStringParameter**](../Model/.md)| Filters bigmaps by path in the contract storage. | [optional]
 **tags** | [**OneOfBigMapTagsParameter**](../Model/.md)| Filters bigmaps by tags: &#x60;token_metadata&#x60; - tzip-12, &#x60;metadata&#x60; - tzip-16. | [optional]
 **active** | **bool**| Filters bigmaps by status: &#x60;true&#x60; - active, &#x60;false&#x60; - removed. | [optional]
 **last_level** | [**OneOfInt32Parameter**](../Model/.md)| Filters bigmaps by the last update level. | [optional]

...
```php
blocksGet($baker, $level, $timestamp, $priority, $select, $sort, $offset, $limit, $quote): \Bzzhh\Tzkt\Model\Block[]
```
...
$baker = new \Bzzhh\Tzkt\Model\OneOfAccountParameter(); // OneOfAccountParameter | Filters blocks by baker. Allowed fields for `.eqx` mode: none.
$level = new \Bzzhh\Tzkt\Model\OneOfInt32Parameter(); // OneOfInt32Parameter | Filters blocks by level.
$timestamp = new \Bzzhh\Tzkt\Model\OneOfDateTimeParameter(); // OneOfDateTimeParameter | Filters blocks by timestamp.
$priority = new \Bzzhh\Tzkt\Model\OneOfInt32Parameter(); // OneOfInt32Parameter | Filters blocks by priority.
...
$sort = new \Bzzhh\Tzkt\Model\OneOfSortParameter(); // OneOfSortParameter | Sorts blocks by specified field. Supported fields: `id` (default), `level`, `priority`, `validations`, `reward`, `fees`.
...
try {
    $result = $apiInstance->blocksGet($baker, $level, $timestamp, $priority, $select, $sort, $offset, $limit, $quote);
    print_r($result);
} catch (Exception $e) {
...
------------- | ------------- | ------------- | -------------
 **baker** | [**OneOfAccountParameter**](../Model/.md)| Filters blocks by baker. Allowed fields for &#x60;.eqx&#x60; mode: none. | [optional]
 **level** | [**OneOfInt32Parameter**](../Model/.md)| Filters blocks by level. | [optional]
 **timestamp** | [**OneOfDateTimeParameter**](../Model/.md)| Filters blocks by timestamp. | [optional]
 **priority** | [**OneOfInt32Parameter**](../Model/.md)| Filters blocks by priority. | [optional]
 ...
 **sort** | [**OneOfSortParameter**](../Model/.md)| Sorts blocks by specified field. Supported fields: &#x60;id&#x60; (default), &#x60;level&#x60;, &#x60;priority&#x60;, &#x60;validations&#x60;, &#x60;reward&#x60;, &#x60;fees&#x60;. | [optional]

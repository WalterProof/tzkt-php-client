...
$snapshot_index = new \Bzzhh\Tzkt\Model\OneOfInt32Parameter(); // OneOfInt32Parameter | Filters cycles by snapshot index (0..15)
...
$sort = new \Bzzhh\Tzkt\Model\OneOfSortParameter(); // OneOfSortParameter | Sorts cycles by specified field. Supported fields: `index` (default, desc).
...
------------- | ------------- | ------------- | -------------
 **snapshot_index** | [**OneOfInt32Parameter**](../Model/.md)| Filters cycles by snapshot index (0..15) | [optional]
 ...
 **sort** | [**OneOfSortParameter**](../Model/.md)| Sorts cycles by specified field. Supported fields: &#x60;index&#x60; (default, desc). | [optional]
